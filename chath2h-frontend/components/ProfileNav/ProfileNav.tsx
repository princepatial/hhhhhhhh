...
// Make avatar optional in Props
type Props = {
  avatar?: Photo; // Changed to optional
  firstName: string;
  style?: string;
};

const ProfileNav = ({ avatar = {
  filename: ''
}, firstName, style }: Props) => { // Provide default value for avatar
  const { t } = useTranslation('common');
  
  // Use optional chaining and fallback for filename
  const src = useImageUrl(avatar?.filename || ''); // Use optional chaining
...
  // Conditional rendering for loading state or avatar
  if (!avatar) {
    return <div>Loading...</div>; // Placeholder while loading avatar
  }
